...
/**
 * Title: Footer links
 * Slug: expose-travel/footer-links
 * Categories: text
 * Inserter: no
 *
...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group">
		...
		printf(
			...
			esc_html__( 'Copyright %s. ', 'expose-travel' ),
			esc_html( date_i18n( _x( 'Y', 'copyright date format', 'expose-travel' ) ) ),
		);
		esc_html_e( 'All right reserved.', 'expose-travel' );
		?>
		</p>
