...
<div class="wp-block-columns blog-wrap"><!-- wp:column {"width":"40%","className":"blog-left"} -->
<div class="wp-block-column blog-left" style="flex-basis:40%"><!-- wp:query {"queryId":14,"query":{"perPage":1,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":null,"parents":[],"format":[]}} -->
...
<!-- wp:column {"width":"60%","className":"blog-right"} -->
<div class="wp-block-column blog-right" style="flex-basis:60%"><!-- wp:query {"queryId":14,"query":{"perPage":2,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"post_tag":[]},"parents":[],"format":[]}} -->
<div class="wp-block-query"><!-- wp:post-template {"layout":{"type":"default","columnCount":3}} -->
